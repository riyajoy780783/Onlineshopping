	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException, IOException  {
		...
		case 1:
			...
			case 2:
				...
				statement.executeUpdate("update addproduct SET toatal_cost ='"+price1+"'where Id='"+pId1+"'and quantity_available='"+qnty+"'");
				
				
				ResultSet rs1=statement.executeQuery("select Id,product_name,min_sell,price,quantity_available,toatal_cost from addproduct where Id='"+pId1+"'");
				while (rs1.next()) {
		            int id = rs1.getInt(1);
				...
				if(b.equalsIgnoreCase("buy"))
				{
					...
					if(qnty<=qn)
					{
						...
						if(y.equalsIgnoreCase("Yes"))
						{
							...
							statement.executeUpdate("update addproduct SET toatal_cost ='"+tot1+"'where Id='"+prId+"'");
